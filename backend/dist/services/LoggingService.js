...
console.log('----------> Log level services: ', config.getConfig().logging.services);
console.log('----------> Log level controllers: ', config.getConfig().logging.controllers);
console.log('----------> Log level general: ', config.getConfig().logging.general);
